...
@Composable
fun PendingVerificationScreen(onLogout: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Text(
            text = "لقد استلمنا طلب تسجيلك والمرفقات الخاصة بإثبات الهوية. سيقوم مدير النظام بمراجعة الطلب والموافقة عليه قريباً. يرجى التحلي بالصبر.",
            fontSize = 16.sp,
